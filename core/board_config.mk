...
# Are we building a persist image
BUILDING_PERSIST_IMAGE :=
ifeq ($(PRODUCT_BUILD_PERSIST_IMAGE),)
  ifdef BOARD_PERSISTIMAGE_PARTITION_SIZE
    BUILDING_PERSIST_IMAGE := true
  endif
else ifeq ($(PRODUCT_BUILD_PERSIST_IMAGE),true)
  BUILDING_PERSIST_IMAGE := true
endif
.KATI_READONLY := BUILDING_PERSIST_IMAGE
